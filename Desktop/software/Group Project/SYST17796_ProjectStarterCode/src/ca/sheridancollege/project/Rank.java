...
/**
 * @Enum representing the ranks of cards in a standard deck. Each rank has an associated value used
 * for comparing cards.
 * @author sneh July 19, 2024
 */

/*
 t factory pattern is used  for creating instaces of this enum class
*/
public enum Rank {
